  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid cont">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <?php } ?>
              <li class="nav-item">
                <a class="nav-link " aria-current="page" href="../user/why.php">Why to Donate?</a>
              </li>
              <li class="nav-item">
                <a class="nav-link " aria-current="page" href="../user/login.php">Donation</a>
              </li>
              <li class="nav-item">
                <a class="nav-link " aria-current="page" href="../user/login.php">Need Blood</a>
              </li>
              <li class="nav-item">
