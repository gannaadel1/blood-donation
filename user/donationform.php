...
if(isset($_POST['submit'])){
    ...
    $gender=$_POST['gender'];
$insert="INSERT INTO `donator` VALUES (NULL,'$national_id ','$name','$phone','$donator_age' ,'$donator_address','$donator_location','$blood_type','$donator_diseases','$gender' ) ";
